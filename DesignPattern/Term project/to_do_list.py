...
class CalendarWindow:
    def __init__(self):
        ...
        self.cal.bind("<<CalendarSelected>>", self.show_add_task_window)
    
    def update_task_listbox(self):
        self.todo_window.update_tasks()

    def show_add_task_window(self, event):
        selected_date = self.cal.get_date()
        add_task_window = AddTaskWindow(selected_date, self.tasks, self, self.todo_window)
        add_task_window.open()
